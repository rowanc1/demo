  ...
  children: [
    {
      type: 'block',
      position: {
        start: { offset: 141, line: 11, column: 1 },
        end: { offset: 149, line: 11, column: 9 },
      },
      children: [
        {
          type: 'heading',
          ...
          children: [
            {
              ...
              value:
                'Quantum mechanics is a fundamental theory in physics that describes the behavior of particles at the microscopic level. It provides a mathematical framework for understanding the wave-particle duality of matter and the probabilistic nature of physical phenomena.',
              key: 'WTzoDxev7r',
            },
          ],
          key: 'EPWqb6R99V',
    ...
    },
    {
      type: 'block',
      position: {
        start: { offset: 427, line: 14, column: 1 },
        end: { offset: 435, line: 14, column: 9 },
      },
      children: [
        {
          type: 'heading',
          ...
          children: [
            {
              ...
              value:
                'There are several key concepts in quantum mechanics that are essential to understanding the theory:',
              key: 'yXHzVFmUsI',
            },
          ],
          key: 'GUjRIn1gTx',
        },
        {
          type: 'list',
          position: {
            start: { offset: 554, line: 17, column: 1 },
            end: { offset: 1424, line: 23, column: 14 },
          },
          ordered: false,
          children: [
            {
                  ...
                  children: [
                    {
                      ...
                      value:
                        'Wave-particle duality: Particles such as electrons and photons can exhibit both wave-like and particle-like behavior, depending on the experimental setup.',
                      key: 'vwS16uHw2I',
                    },
                  ],
                  key: 'cST8q2Y6jG',
                  ...
                  children: [
                    {
                      ...
                      value:
                        'Superposition: Quantum systems can exist in multiple states simultaneously, thanks to the principle of superposition.',
                      key: 'igBlRn3gtZ',
                    },
                  ],
                  key: 'OQPd4JfXJv',
                  ...
                  children: [
                    {
                      ...
                      value:
                        'Measurement and collapse: When a quantum system is measured, its wavefunction collapses to a single state, corresponding to the observed measurement outcome.',
                      key: 'OmzgEYfNiW',
                    },
                  ],
                  key: 'V9P9QEsNxO',
                  ...
                  children: [
                    {
                      ...
                      value:
                        'Uncertainty principle: There is a fundamental limit to the precision with which certain pairs of physical properties, such as position and momentum, can be simultaneously known.',
                      key: 'PZma3ZdKSC',
                    },
                  ],
                  key: 'CU8yTq9OnE',
                  ...
                  children: [
                    {
                      ...
                      value:
                        'Quantum entanglement: Two or more particles can become entangled, such that the state of one particle is dependent on the state of the other(s), regardless of the distance between them.',
                      key: 'WZIJK37M4t',
                    },
                  ],
                  key: 'JU5nvWrlLz',
    ...
    },
    {
      type: 'block',
      position: {
        start: { offset: 1428, line: 25, column: 1 },
        end: { offset: 1436, line: 25, column: 9 },
      },
      children: [
        {
          type: 'heading',
        ...
        },
        {
          type: 'list',
          position: {
            start: { offset: 1529, line: 28, column: 1 },
            end: { offset: 2168, line: 32, column: 14 },
          },
          ordered: false,
          children: [
            {
                  ...
                  children: [
                    {
                      ...
                      value:
                        'Quantum computing: Quantum computers leverage the principles of quantum mechanics to perform certain computations much faster than classical computers.',
                      key: 'Z5dgJAbjXd',
                    },
                  ],
                  key: 'xS02oX5AkW',
                  ...
                  children: [
                    {
                      ...
                      value:
                        'Quantum cryptography: Quantum mechanics provides a secure method for transmitting information, as any attempt to intercept the communication would disturb the quantum state and be detectable.',
                      key: 'p7npkqXVSc',
                    },
                  ],
                  key: 'PuqvxkrHYG',
                  ...
                  children: [
                    {
                      ...
                      value:
                        'Quantum physics research: Quantum mechanics is the foundation for studying and understanding the behavior of particles and systems at the quantum level, leading to advancements in fields such as materials science, chemistry, and biology.',
                      key: 'DFbDYmCBqO',
                    },
                  ],
                  key: 'pEQdGeGCp7',
    ...
    },
    {
      type: 'block',
      position: {
        start: { offset: 2172, line: 34, column: 1 },
        end: { offset: 2180, line: 34, column: 9 },
      },
      children: [
        {
          type: 'heading',
          ...
          children: [
            {
              ...
              value:
                'Quantum mechanics is a fascinating and powerful theory that has revolutionized our understanding of the physical world. Its principles and applications continue to drive scientific research and technological advancements in various fields.',
              key: 'XaWu8gRkMx',
            },
          ],
          key: 'iup0u7jFNw',
    ...
    },
    {
      type: 'block',
      position: {
        start: { offset: 2437, line: 37, column: 1 },
        end: { offset: 2445, line: 37, column: 9 },
      },
      children: [
        {
          type: 'heading',
        ...
        },
        {
          type: 'heading',
          position: {
            start: { offset: 2483, line: 39, column: 1 },
            end: { offset: 2494, line: 39, column: 12 },
          },
          depth: 3,
          children: [
            {
        ...
        },
        {
          ...
          position: {
            start: { offset: 2664, line: 42, column: 1 },
            end: { offset: 2756, line: 44, column: 3 },
          },
        ...
        },
        {
          type: 'heading',
          position: {
            start: { offset: 2936, line: 48, column: 1 },
            end: { offset: 2947, line: 48, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'For stationary states, where the wavefunction does not depend on time, the Schrödinger equation simplifies to the time-independent Schrödinger equation:',
              key: 'QU7Xi42pMW',
            },
          ],
          key: 'MNGaEMbnSb',
        },
        {
          ...
          position: {
            start: { offset: 3144, line: 51, column: 1 },
            end: { offset: 3197, line: 53, column: 3 },
          },
        ...
        },
        {
          type: 'heading',
          position: {
            start: { offset: 3297, line: 57, column: 1 },
            end: { offset: 3308, line: 57, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'The Heisenberg uncertainty principle states that there is a fundamental limit to the precision with which certain pairs of physical properties can be simultaneously known. Mathematically, it is expressed as:',
              key: 'pnhh9KG6ow',
            },
          ],
          key: 'gEntZwKwNW',
        },
        {
          ...
          position: {
            start: { offset: 3555, line: 60, column: 1 },
            end: { offset: 3601, line: 62, column: 3 },
          },
        ...
        },
        {
          type: 'heading',
          position: {
            start: { offset: 3703, line: 66, column: 1 },
            end: { offset: 3714, line: 66, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'The Pauli exclusion principle states that no two identical fermions can occupy the same quantum state simultaneously. This principle is responsible for the stability of matter and the formation of electron shells in atoms.',
              key: 'dV9zBgVxf3',
            },
          ],
          key: 'VX5pAbStMW',
        },
        {
          type: 'heading',
          position: {
            start: { offset: 3969, line: 69, column: 1 },
            end: { offset: 3980, line: 69, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'Quantum entanglement is a phenomenon in which two or more particles become correlated in such a way that the state of one particle is dependent on the state of the other(s), regardless of the distance between them. This phenomenon is a key aspect of quantum information and quantum computing.',
              key: 'K1FvXLvG4b',
            },
          ],
          key: 'LRwHCoCe2L',
        },
        {
          type: 'heading',
          position: {
            start: { offset: 4300, line: 72, column: 1 },
            end: { offset: 4311, line: 72, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'The time-dependent Schrödinger equation describes the time evolution of a quantum system. It is given by:',
              key: 't0t7e6PQSy',
            },
          ],
          key: 'j5HoQKpdRc',
        },
        {
          ...
          value:
            'i\\hbar \\frac{\\partial}{\\partial t} \\Psi(\\mathbf{r}, t) = \\hat{H} \\Psi(\\mathbf{r}, t)',
          position: {
            start: { offset: 4459, line: 75, column: 1 },
            end: { offset: 4551, line: 77, column: 3 },
          },
          html: '<span class="katex-display"><span class="katex"><span class="katex-mathml"><math xmlns="http://www.w3.org/1998/Math/MathML" display="block"><semantics><mrow><mi>i</mi><mi mathvariant="normal">ℏ</mi><mfrac><mi mathvariant="normal">∂</mi><mrow><mi mathvariant="normal">∂</mi><mi>t</mi></mrow></mfrac><mi mathvariant="normal">Ψ</mi><mo stretchy="false">(</mo><mi mathvariant="bold">r</mi><mo separator="true">,</mo><mi>t</mi><mo stretchy="false">)</mo><mo>=</mo><mover accent="true"><mi>H</mi><mo>^</mo></mover><mi mathvariant="normal">Ψ</mi><mo stretchy="false">(</mo><mi mathvariant="bold">r</mi><mo separator="true">,</mo><mi>t</mi><mo stretchy="false">)</mo></mrow><annotation encoding="application/x-tex">i\\hbar \\frac{\\partial}{\\partial t} \\Psi(\\mathbf{r}, t) = \\hat{H} \\Psi(\\mathbf{r}, t)</annotation></semantics></math></span><span class="katex-html" aria-hidden="true"><span class="base"><span class="strut" style="height:2.0574em;vertical-align:-0.686em;"></span><span class="mord mathnormal">i</span><span class="mord">ℏ</span><span class="mord"><span class="mopen nulldelimiter"></span><span class="mfrac"><span class="vlist-t vlist-t2"><span class="vlist-r"><span class="vlist" style="height:1.3714em;"><span style="top:-2.314em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord" style="margin-right:0.05556em;">∂</span><span class="mord mathnormal">t</span></span></span><span style="top:-3.23em;"><span class="pstrut" style="height:3em;"></span><span class="frac-line" style="border-bottom-width:0.04em;"></span></span><span style="top:-3.677em;"><span class="pstrut" style="height:3em;"></span><span class="mord"><span class="mord" style="margin-right:0.05556em;">∂</span></span></span></span><span class="vlist-s">​</span></span><span class="vlist-r"><span class="vlist" style="height:0.686em;"><span></span></span></span></span></span><span class="mclose nulldelimiter"></span></span><span class="mord">Ψ</span><span class="mopen">(</span><span class="mord mathbf">r</span><span class="mpunct">,</span><span class="mspace" style="margin-right:0.1667em;"></span><span class="mord mathnormal">t</span><span class="mclose">)</span><span class="mspace" style="margin-right:0.2778em;"></span><span class="mrel">=</span><span class="mspace" style="margin-right:0.2778em;"></span></span><span class="base"><span class="strut" style="height:1.1968em;vertical-align:-0.25em;"></span><span class="mord accent"><span class="vlist-t"><span class="vlist-r"><span class="vlist" style="height:0.9468em;"><span style="top:-3em;"><span class="pstrut" style="height:3em;"></span><span class="mord mathnormal" style="margin-right:0.08125em;">H</span></span><span style="top:-3.2523em;"><span class="pstrut" style="height:3em;"></span><span class="accent-body" style="left:-0.1944em;"><span class="mord">^</span></span></span></span></span></span></span><span class="mord">Ψ</span><span class="mopen">(</span><span class="mord mathbf">r</span><span class="mpunct">,</span><span class="mspace" style="margin-right:0.1667em;"></span><span class="mord mathnormal">t</span><span class="mclose">)</span></span></span></span></span>',
          enumerator: '4',
          key: 'lPqZj3vh1a',
        ...
        },
        {
          type: 'heading',
          position: {
            start: { offset: 4731, line: 81, column: 1 },
            end: { offset: 4742, line: 81, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'The Dirac equation is a relativistic wave equation that describes the behavior of fermions, such as electrons. It is given by:',
              key: 'teQ55fTLNX',
            },
          ],
          key: 'A3oRHTCRvk',
        },
        {
          ...
          position: {
            start: { offset: 4890, line: 84, column: 1 },
            end: { offset: 4936, line: 86, column: 3 },
          },
        ...
        },
        {
          type: 'heading',
          position: {
            start: { offset: 5103, line: 90, column: 1 },
            end: { offset: 5114, line: 90, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'Quantum field theory is a framework that combines quantum mechanics and special relativity to describe the behavior of particles and fields. It is based on the principles of quantization and the concept of fields as operators. The equations of quantum field theory include the Klein-Gordon equation, the Dirac equation, and the Yang-Mills equations.',
              key: 'uDnSi3caGt',
            },
          ],
          key: 'QsN122QY7o',
        },
        {
          type: 'heading',
          position: {
            start: { offset: 5491, line: 93, column: 1 },
            end: { offset: 5502, line: 93, column: 12 },
          },
          depth: 3,
          children: [
            {
        ...
        },
        {
          type: 'heading',
          position: {
            start: { offset: 5916, line: 96, column: 1 },
            end: { offset: 5927, line: 96, column: 12 },
          },
          depth: 3,
          children: [
            {
        ...
        },
        {
          type: 'heading',
          position: {
            start: { offset: 6318, line: 99, column: 1 },
            end: { offset: 6329, line: 99, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'Quantum gravity is a theoretical framework that aims to describe the gravitational interaction in the framework of quantum mechanics. It is based on the principles of general relativity and quantum field theory. The equations of quantum gravity are still under active research and include the Wheeler-DeWitt equation and various approaches such as string theory and loop quantum gravity.',
              key: 'fjwWPmD4zF',
            },
          ],
          key: 'tY6GQ6gN9U',
        },
        {
          type: 'heading',
          position: {
            start: { offset: 6739, line: 102, column: 1 },
            end: { offset: 6750, line: 102, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'The Wheeler-DeWitt equation is a key equation in quantum gravity that attempts to describe the quantum state of the entire universe. It is a constraint equation that arises from the quantization of general relativity.',
              key: 'wDl4yMOjTS',
            },
          ],
          key: 'fyVHhzsLY3',
        },
        {
          ...
          position: {
            start: { offset: 6998, line: 105, column: 1 },
            end: { offset: 7034, line: 107, column: 3 },
          },
        ...
        },
        {
          type: 'heading',
          position: {
            start: { offset: 7148, line: 111, column: 1 },
            end: { offset: 7159, line: 111, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'String theory is a theoretical framework that attempts to unify quantum mechanics and general relativity. It describes elementary particles as tiny, vibrating strings. The equations of string theory involve the dynamics of these strings and their interactions.',
              key: 'XYFvXcaNaR',
            },
          ],
          key: 'frvYFhi5bs',
        },
        {
          type: 'heading',
          position: {
            start: { offset: 7440, line: 114, column: 1 },
            end: { offset: 7451, line: 114, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'Loop quantum gravity is another approach to quantum gravity that quantizes space itself. It represents space as a network of interconnected loops. The equations of loop quantum gravity involve the quantization of these loops and the dynamics of the resulting quantum spacetime.',
              key: 'G8ixwTvzux',
            },
          ],
          key: 'Npl53iufFk',
        },
        {
          type: 'heading',
          position: {
            start: { offset: 7756, line: 117, column: 1 },
            end: { offset: 7767, line: 117, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'Black hole thermodynamics is a field that studies the thermodynamic properties of black holes. It combines concepts from general relativity and quantum mechanics. The equations of black hole thermodynamics include the laws of black hole mechanics and the Bekenstein-Hawking entropy formula.',
              key: 'XlwgOunrXT',
            },
          ],
          key: 'r3JFQfw5gS',
        },
        {
          type: 'heading',
          position: {
            start: { offset: 8090, line: 120, column: 1 },
            end: { offset: 8101, line: 120, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'Emergent gravity is a concept that suggests that gravity is not a fundamental force, but rather emerges from the collective behavior of underlying microscopic degrees of freedom. The equations of emergent gravity describe how the macroscopic gravitational field arises from the microscopic constituents.',
              key: 'wy5gdgERy6',
            },
          ],
          key: 'EhRLjBPPrb',
        },
        {
          type: 'heading',
          position: {
            start: { offset: 8428, line: 123, column: 1 },
            end: { offset: 8439, line: 123, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'Quantum cosmology is the application of quantum mechanics to the study of the universe as a whole. It aims to describe the quantum state of the universe and its evolution. The equations of quantum cosmology include the Wheeler-DeWitt equation and various models of the early universe.',
              key: 'Kfq2UR7uAi',
            },
          ],
          key: 'pw8qKlvrjj',
        },
        {
          type: 'heading',
          position: {
            start: { offset: 8748, line: 126, column: 1 },
            end: { offset: 8759, line: 126, column: 12 },
          },
          depth: 3,
          children: [
            {
        ...
        },
        {
          type: 'heading',
          position: {
            start: { offset: 9101, line: 129, column: 1 },
            end: { offset: 9112, line: 129, column: 12 },
          },
          depth: 3,
          children: [
            {
        ...
        },
        {
          type: 'heading',
          position: {
            start: { offset: 9511, line: 132, column: 1 },
            end: { offset: 9522, line: 132, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'The holographic principle is a concept that suggests that the information content of a region of spacetime is encoded on its boundary. It has deep connections to quantum gravity and the nature of spacetime. The equations of the holographic principle involve the relationship between the bulk and boundary descriptions of a quantum gravitational system.',
              key: 'dOVLx6jbxI',
            },
          ],
          key: 'A1mWMpUyoc',
        },
        {
          type: 'heading',
          position: {
            start: { offset: 9927, line: 135, column: 1 },
            end: { offset: 9938, line: 135, column: 12 },
          },
          depth: 3,
          children: [
            {
          ...
          children: [
            {
              ...
              value:
                'Quantum gravity provides insights into the behavior of black holes, including their formation, evaporation, and information loss paradox. The equations of quantum gravity help explain the microscopic structure of black holes and their thermodynamic properties.',
              key: 'msEeF8oYo5',
            },
          ],
          key: 'c86BHSrKhF',
          ...
          children: [
            {
              ...
              value:
                'Quantum gravity plays a crucial role in understanding the early universe, the Big Bang, and the inflationary period. The equations of quantum gravity provide insights into the origin and evolution of the universe on a cosmological scale.',
              key: 'mgNwrIIkmA',
            },
          ],
          key: 'NCDdYnReFQ',
          ...
          children: [
            {
              ...
              value:
                'Quantum gravity addresses the issue of singularities, such as those found in black holes and the Big Bang. The equations of quantum gravity help resolve the infinities associated with singularities and provide a more complete description of these phenomena.',
              key: 'h1R3LBF7O0',
            },
          ],
          key: 'ZswfcPHUTS',
          ...
          children: [
            {
              ...
              value:
                'Quantum gravity explores the fundamental nature of spacetime and its quantization. The equations of quantum gravity describe the dynamics of spacetime at the smallest scales and provide insights into the nature of geometry and topology.',
              key: 'sBrrZdNdUj',
            },
          ],
          key: 'se5pC7Qu4v',
          ...
          children: [
            {
              ...
              value:
                'Quantum gravity theories, such as string theory and loop quantum gravity, offer possibilities for a multiverse, where multiple universes coexist. The equations of quantum gravity help explore the existence and properties of these parallel universes.',
              key: 'DUBVhpeLlv',
            },
          ],
          key: 'qXSebTUngq',
          ...
          children: [
            {
              ...
              value:
                'Quantum gravity investigates the origin and nature of the arrow of time, which determines the directionality of cause and effect. The equations of quantum gravity provide insights into the fundamental laws that govern the flow of time.',
              key: 'ccaDs7RspM',
            },
          ],
          key: 'NaFnhT7vwt',
          ...
          children: [
            {
              ...
              value:
                'Quantum gravity has connections to quantum information theory, which studies the fundamental limits and possibilities of information processing. The equations of quantum gravity help explore the role of information in the fabric of spacetime.',
              key: 'y3ACuIDQiO',
            },
          ],
          key: 'ABJlAPuere',
          ...
          children: [
            {
              ...
              value:
                'Quantum gravity theories aim to reconcile the principles of quantum mechanics with those of general relativity. The equations of quantum gravity provide a framework for understanding the fundamental nature of quantum mechanics and its relationship to gravity.',
              key: 'wlK05hsdGp',
            },
          ],
          key: 'F7Jm6GhoDg',
          ...
          children: [
            {
              ...
              value:
                'Quantum gravity theories make predictions that can be tested through experiments and observations. The equations of quantum gravity help formulate these predictions and guide the design of experiments to probe the quantum nature of gravity.',
              key: 'HTUbXmiKy0',
            },
          ],
          key: 'CTuEB6LLdt',
          ...
          children: [
            {
              ...
              value:
                'Quantum gravity seeks to unify the fundamental forces of nature, including gravity, electromagnetism, and the strong and weak nuclear forces. The equations of quantum gravity provide insights into the possibility of a unified theory that encompasses all known forces.',
              key: 'idSg5ZSde9',
            },
          ],
          key: 'Qkuk5PdbjU',
          ...
          children: [
            {
              ...
              value:
                'Quantum gravity theories explore the nature of matter at the most fundamental level. The equations of quantum gravity help understand the behavior of elementary particles and their interactions in the context of a quantum gravitational framework.',
              key: 'DtnLYFVann',
            },
          ],
          key: 'RY5zIkOXFd',
